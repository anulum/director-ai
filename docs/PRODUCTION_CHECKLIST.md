...
> **Module**: Director-AI | **Version**: 3.15.3 | **License**: Apache-2.0 core / BUSL-1.1 advanced
>
...
| **NLI** | `pip install "director-ai[nli]"` | 77.8% BA | See benchmark packets | Production fact-checking |
| **NLI+RAG** | `pip install "director-ai[nli,vector]"` | 77.8%+ | See benchmark packets | KB-grounded verification |
| **Full** | `pip install "director-ai[nli,vector,server]"` | 77.8%+ | See benchmark packets | Self-hosted API |
