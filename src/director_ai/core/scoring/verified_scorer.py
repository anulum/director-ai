...
The text-level signal kernels (sentence splitting, entity/numerical/
negation/traceability checks, summation reducers and their Rust dispatch)
live in :mod:`director_ai.core.scoring._claim_signals`; this module keeps
the verdict types and the multi-signal verification pipeline, re-exporting
the signal functions for their historical import surface.
"""
...
from ._claim_signals import (
    _decompose_atomic as _decompose_atomic,
)
from ._claim_signals import (
    _entity_overlap as _entity_overlap,
)
from ._claim_signals import (
    _negation_flip as _negation_flip,
)
from ._claim_signals import (
    _numerical_consistency as _numerical_consistency,
)
from ._claim_signals import (
    _split_sentences as _split_sentences,
)
from ._claim_signals import (
    _sum_float as _sum_float,
)
from ._claim_signals import (
    _sum_int as _sum_int,
)
from ._claim_signals import (
    _traceability as _traceability,
)
from ._claim_signals import (
    _word_overlap as _word_overlap,
)
