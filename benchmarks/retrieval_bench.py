...
EVAL_SET: list[tuple[str, str, str, list[str]]] = [
    ...
    (
        "absolute_zero",
        "Absolute zero is -273.15 degrees Celsius (0 Kelvin).",
    ...
    (
        "e_charge",
        "The elementary charge is 1.602 × 10⁻¹⁹ coulombs.",
    ...
    (
        "c_boiling",
        "Ethanol boils at 78.37 degrees Celsius.",
    ...
    (
        "ozone_layer",
        "The ozone layer absorbs most UV-B radiation from the Sun.",
    ...
    (
        "mars_gravity",
        "Mars surface gravity is 3.72 m/s², about 38% of Earth's.",
    ...
    (
        "human_body_water",
        "The adult human body is approximately 60% water.",
