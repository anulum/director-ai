...
# Director-Class AI - Gemma routed logprob scoring CLI
"""Run routed Gemma prompts as a hallucination judge with logprob scores."""
...
from _gemma_aggrefact_logprob_routed_report import (
    build_report,
    log_summary,
    write_report,
)
...
def main() -> None:
    """Run the routed Gemma AggreFact logprob benchmark CLI."""
...
def _build_parser() -> argparse.ArgumentParser:
    """Create the command-line parser for the routed logprob evaluator."""
