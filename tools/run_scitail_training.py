...
# Director-Class AI — run_scitail_training
#!/usr/bin/env python3
"""Fine-tune FactCG-DeBERTa-v3-Large on SciTail for scientific domain.

SciTail: ~27K hypothesis-premise pairs from science exams (Allen AI).
Binary: entailment=1, neutral=0 (SciTail has no contradiction class).

Usage:
    python run_scitail_training.py [--resume]
"""
...
OUTPUT_DIR = "/home/director-ai/models/factcg-scitail"
TEMPLATE = (
...
def load_scitail():
    ...
    print(f"SciTail loaded: train={len(train)}, val={len(val)}, test={len(test)}")
...
def main():
    ...
    print("=== SciTail Fine-Tuning (Scientific Domain) ===")
    ...
    train_ds, val_ds, test_ds = load_scitail()
