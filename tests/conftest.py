...
tests/test_coverage_nli_gaps.py::TestRustAcceleratedMathBranches::test_rust_confidence_non_runtime_exception_falls_back_to_python
tests/test_coverage_nli_gaps.py::TestRustAcceleratedMathBranches::test_rust_confidence_type_error_falls_back_to_python
tests/test_coverage_nli_gaps.py::TestRustAcceleratedMathBranches::test_rust_divergence_non_runtime_exception_falls_back_to_python
tests/test_coverage_nli_gaps.py::TestRustAcceleratedMathBranches::test_rust_divergence_type_error_falls_back_to_python
tests/test_coverage_scorer.py::TestScorerHeuristicFactual::test_rust_heuristic_factual_non_runtime_exception_falls_back_to_python
tests/test_coverage_scorer.py::TestScorerHeuristicFactual::test_rust_heuristic_factual_type_error_falls_back_to_python
tests/test_coverage_scorer.py::TestScorerLogical::test_rust_heuristic_logical_non_runtime_exception_falls_back_to_python
tests/test_coverage_scorer.py::TestScorerLogical::test_rust_heuristic_logical_type_error_falls_back_to_python
...
tests/test_federated_privacy.py::TestAccountantRustSums::test_rust_sum_type_error_falls_back_to_python
tests/test_federated_privacy.py::TestAggregatorRustSums::test_rust_sum_i64_type_error_falls_back
...
tests/test_knowledge.py::TestGroundTruthStore::test_rust_overlap_exception_falls_back_to_python
tests/test_knowledge.py::TestGroundTruthStore::test_rust_overlap_non_runtime_exception_falls_back_to_python
tests/test_knowledge.py::TestGroundTruthStore::test_rust_overlap_type_error_falls_back_to_python
...
tests/test_meta_classifier.py::TestWordOverlapRustDelegation::test_rust_overlap_exception_falls_back_to_python
tests/test_meta_classifier.py::TestWordOverlapRustDelegation::test_rust_overlap_non_runtime_exception_falls_back_to_python
tests/test_meta_classifier.py::TestWordOverlapRustDelegation::test_rust_overlap_type_error_falls_back_to_python
...
tests/test_reasoning_verifier.py::TestVerifyReasoningChain::test_word_overlap_falls_back_when_rust_ffi_raises
tests/test_reasoning_verifier.py::TestVerifyReasoningChain::test_word_overlap_falls_back_when_rust_ffi_raises_non_runtime
tests/test_reasoning_verifier.py::TestVerifyReasoningChain::test_word_overlap_falls_back_when_rust_ffi_raises_type_error
...
tests/test_rust_signals.py::TestTrendDrop::test_rust_trend_drop_exception_falls_back_to_python
tests/test_rust_signals.py::TestTrendDrop::test_rust_trend_drop_non_runtime_exception_falls_back_to_python
tests/test_rust_signals.py::TestTrendDrop::test_rust_trend_drop_type_error_falls_back_to_python
...
tests/test_streaming.py::TestStreamingRustMean::test_rust_mean_type_error_falls_back_to_python
