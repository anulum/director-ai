...
class TestMerkleCommitment:
    ...
    def test_rust_merkle_walk_path_non_runtime_exception_falls_back_to_python(
        self, monkeypatch
    ):
        monkeypatch.setattr(commitment_mod, "_RUST_MERKLE_AVAILABLE", True)
        monkeypatch.setattr(
    ...
    def test_rust_merkle_mixed_non_runtime_exceptions_fall_back_to_python(
        self, monkeypatch
    ):
        monkeypatch.setattr(commitment_mod, "_RUST_MERKLE_AVAILABLE", True)
        monkeypatch.setattr(
        ...
        monkeypatch.setattr(
            commitment_mod,
            "_rust_merkle_auth_path",
            lambda _leaves, _index: (_ for _ in ()).throw(TypeError("ffi fail")),
            raising=False,
        )
        monkeypatch.setattr(
            commitment_mod,
