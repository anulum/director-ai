...
def test_autopoietic_unit_guard_has_real_surface_companion() -> None:
    """Autopoietic guard should be backed by public evolution coverage."""
    classification, category = KNOWN_TEST_SURFACE_CLASSIFICATIONS[
...
def test_dspy_integration_unit_guard_has_real_surface_companion() -> None:
    """DSPy integration guards should be backed by real adapter coverage."""
    classification, category = KNOWN_TEST_SURFACE_CLASSIFICATIONS[
...
def test_cyber_physical_unit_guard_has_real_surface_companion() -> None:
    """Cyber-physical unit guard should use the production facade companion."""
    classification, category = KNOWN_TEST_SURFACE_CLASSIFICATIONS[
        "tests/test_cyber_physical.py"
    ]

    assert classification == "unit-guard-with-companion"
    assert "tests/test_cyber_physical_real_surface.py" in category


def test_data_pipeline_unit_guard_has_real_surface_companion() -> None:
    """Training data pipeline unit guard should use the real CLI companion."""
    classification, category = KNOWN_TEST_SURFACE_CLASSIFICATIONS[
        "tests/test_data_pipeline.py"
    ]

    assert classification == "unit-guard-with-companion"
    assert "tests/test_data_pipeline_real_surface.py" in category
...
def test_multimodal_guard_unit_guard_has_real_surface_companion() -> None:
    """Multimodal guard primitives should have public companion coverage."""
    classification, category = KNOWN_TEST_SURFACE_CLASSIFICATIONS[
