...
`director-ai quickstart --run`. GPU, TensorRT, gateway, formal-verifier, and
WASM paths are advanced runtimes; keep them opt-in unless the deployment
requires them. See [Runtime Boundaries](../guide/runtime-boundaries.md).
