...
# Director-Class AI — customer_support_guard
#!/usr/bin/env python3
...
cases = [
    ("Refund policy?", "We offer refunds within 30 days of purchase.", True),
    ("Refund policy?", "Full refunds anytime within 90 days.", False),
    ("How much is the Pro plan?", "The Pro plan costs $49 per month.", True),
    ("How much is the Pro plan?", "The Pro plan is free forever.", False),
]
